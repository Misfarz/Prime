...
const addToWishlist = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: 'Product added to wishlist', inWishlist: true });
    } catch (error) {
...
const removeFromWishlist = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: 'Product removed from wishlist', inWishlist: false });
    } catch (error) {
