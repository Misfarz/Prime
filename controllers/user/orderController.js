...
const generateInvoice = async (req, res,next) => {
  try {
    ...
    doc
      .fontSize(10)
      .text("Premium Sports Jerseys & Apparel", { align: "center" });
    doc.moveDown();
    ...
    order.items.forEach((item, i) => {
      ...
      doc
        .text(itemNumber.toString(), itemX, tableRow)
    ...
    doc
      .fontSize(10)
      .text("Thank you for shopping with Prime!", 50, 700, { align: "center" });
